...
![Recruiter Dashboard](screenshots/03_Recruiter_Dashboard.PNG)

### Recruiter — Browse Jobs
![Recruiter Browse Jobs](screenshots/04_Recruiter_Browse_Jobs.PNG)

### Candidate Login
![Candidate Login](screenshots/05_Candidate_Login.PNG)

### Candidate Dashboard — My Applications
![Candidate Applications](screenshots/06_Candidate_My_Applications.PNG)

### Candidate — Browse Jobs
![Candidate Browse Jobs](screenshots/07_Candidate_Browse_Jobs.PNG)

### Candidate — Applied Successfully
![Applied Now](screenshots/08_Candidate_jobs_Applied_Now.PNG)

### Django Administration Panel
![Admin Panel](screenshots/09_Django_Administration.PNG)
